...
By the way, if you want to use vendor CSS frameworks or global styles, just import it through the `./src/layout/index.js` file (app root component). For example:
